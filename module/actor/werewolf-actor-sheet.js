...
export class WerewolfActorSheet extends GhoulActorSheet {
  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["woda20", "sheet", "actor", "werewolf"],
      template: "systems/woda20/templates/actor/werewolf-sheet.html",
      width: 750,
      height: 940,
      tabs: [
        {
  ...
  get template() {
    ...
    return "systems/woda20/templates/actor/werewolf-sheet.html";
  }
  ...
  getData() {
    ...
    data.sheetType = `${game.i18n.localize("WoDA20.Werewolf")}`;
