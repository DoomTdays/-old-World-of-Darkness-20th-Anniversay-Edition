...
export class VampireActorSheet extends GhoulActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["woda20", "sheet", "actor", "vampire"],
      template: "systems/woda20/templates/actor/vampire-sheet.html",
      width: 750,
      height: 940,
      tabs: [
        {
  ...
  get template() {
    ...
    return "systems/woda20/templates/actor/vampire-sheet.html";
  }
  ...
  getData() {
    ...
    data.sheetType = `${game.i18n.localize("WoDA20.Vampire")}`;
