...
export class MageActorSheet extends GhoulActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["woda20", "sheet", "actor", "mage"],
      template: "systems/woda20/templates/actor/mage-sheet.html",
      width: 750,
      height: 940,
      tabs: [
        {
  ...
  get template() {
    ...
    return "systems/woda20/templates/actor/mage-sheet.html";
  }
  ...
  getData() {
    ...
    data.sheetType = `${game.i18n.localize("WoDA20.Mage")}`;

    // Prepare items.
    if (
      this.actor.data.type === "mage" ||
